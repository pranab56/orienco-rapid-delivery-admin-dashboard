      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm flex justify-end gap-3 lg:hidden">
            ...
            <Button type="submit" className="h-11 px-8 rounded-sm font-semibold text-white" style={{ backgroundColor: "#FF4A00" }}>Published</Button>
          </div>
        </div>
        ...
        <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {tags.map((t) => (
                  <Badge
                    key={t}
                    variant="secondary"
                    className="flex items-center gap-1 bg-[#FFF3ED] text-[#FF4A00] border-[#FF4A00]/20"
                  >
                    {t}
                    <X
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm hidden lg:flex justify-stretch gap-3">
            ...
            <Button type="submit" className="flex-1 h-11 rounded-sm font-semibold text-white shadow-lg shadow-orange-100" style={{ backgroundColor: "#FF4A00" }}>Published</Button>
          </div>
        </div>
      </form>
    </div>
