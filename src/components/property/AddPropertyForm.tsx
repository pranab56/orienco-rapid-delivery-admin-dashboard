...
const inputCls =
  "h-11 rounded-lg border text-sm px-4 focus-visible:ring-1 focus-visible:ring-[#FF4A00] focus-visible:border-[#FF4A00]";
    ...
    <div className="w-full flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 space-y-6">
        ...
        <Section title="Basic Information" delay={0.05}>
          ...
          <Field label="Description">
            <Textarea
              className="rounded-sm border text-sm px-4 py-3 min-h-[100px] resize-none focus-visible:ring-1 focus-visible:ring-[#FF4A00] focus-visible:border-[#FF4A00]"
              style={inputStyle}
            ...
            <div className="flex flex-wrap gap-3">
              {amenities.map((checked, i) => (
                <label
                  ...
                  style={{
                    borderColor: checked ? "#FF4A00" : "#F2F2F2",
                    backgroundColor: checked ? "#FFF3ED" : "#FAFAFA",
                  }}
                >
                  <Checkbox
                    checked={checked}
                    ...
                    className="border-[#FF4A00] data-[state=checked]:bg-[#FF4A00] data-[state=checked]:border-[#FF4A00]"
                  />
                  <span className="text-sm font-medium" style={{ color: checked ? "#FF4A00" : "#6C757D" }}>
                    Floor
                  </span>
                </label>
              ))}
        ...
        <Section title="Media Upload" delay={0.2}>
          <div className="flex flex-col gap-1.5">
            ...
            <div
              ...
              style={{
                borderColor: dragOver ? "#FF4A00" : "#E5E7EB",
                backgroundColor: dragOver ? "#FFF3ED" : "#FAFAFA",
              }}
            >
              {preview ? (
                ...
                <>
                  <CloudUpload className="w-10 h-10" style={{ color: "#FF4A00" }} />
      ...
      <div className="flex items-center justify-end gap-3 p-6 px-8shrink-0">
        ...
        <Button
          ...
          style={{ backgroundColor: "#FF4A00", color: "#FFFFFF" }}
        >
          Add a New Listing
        </Button>
      </div>
