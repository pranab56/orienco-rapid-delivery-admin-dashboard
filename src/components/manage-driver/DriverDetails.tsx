  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-right duration-500 pb-10">
      ...
      <div className="space-y-1">
        ...
        <p className="text-[#737780] font-normal">Complete information about this user account.</p>
      </div>
      ...
      <div className="space-y-10">
        ...
        <div className="flex w-full gap-10">
          <Card className="border-none shadow-sm bg-white rounded-xl p-2 overflow-hidden w-4/12">
            <CardContent className="px-10 py-5 flex flex-col items-center text-center">
              <div className="relative w-30 h-30 rounded-full border-4 border-white shadow-xl overflow-hidden mb-6">
                <Image src={"https://i.pravatar.cc/300"} alt={driver.name ?? "Driver"} fill className="object-cover" unoptimized />
              </div>

              <div className="space-y-2 mb-8">
                <h2 className="text-2xl font-medium">{driver.name}</h2>
          ...
          <Card className="border-none shadow-sm bg-white rounded-xl p-2 overflow-hidden w-7/12">
            <CardContent className="p-10 space-y-10">
              <h3 className="text-xl font-bold text-[#2C2E33]">Personal Information</h3>
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h4 className="text-base font-medium text-[#2C2E33]">National ID Card</h4>
      ...
      <div className="grid grid-cols-12 gap-8 mt-10">
        ...
        <div className="col-span-12 lg:col-span-8">
          <Card className="border-none shadow-sm bg-white rounded-xl overflow-hidden h-full min-h-[500px] flex flex-col p-0">
            <CardContent className="p-8 flex-1 flex flex-col gap-6">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold text-[#2C2E33]">Live Vehicle Location</h3>
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
        ...
        <div className="col-span-12 lg:col-span-4">
          <Card className="border-none shadow-sm bg-white rounded-xl overflow-hidden h-full p-0">
            <CardContent className="p-8 space-y-8">
              <h3 className="text-xl font-medium text-[#2C2E33]">ASSIGNED VEHICLE</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="space-y-1 text-center">
                    <p className="text-xl font-medium text-[#2C2E33] leading-none">{driver.vehicle}</p>
                    <p className="text-sm font-medium text-gray-400"># CA-904-XL-22</p>
                  </div>
                  <div className="w-full h-14 bg-[#F2E4DF] flex items-center justify-center rounded-xl">
                    <span className="text-base cursor-pointer font-medium text-[#FF4A00]">Van</span>
                  </div>
                </div>
              </div>
            </CardContent>
