...
export default function HelpSupport() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-10">
      ...
      {/* ── Table Card ── */}
      <Card className="border-none shadow-none bg-white p-2 rounded-lg overflow-visible">
        <CardContent className="p-10 pb-4">
          <div className="w-full">
            ...
            <div className="grid grid-cols-12 pb-6 border-b border-gray-200/50 text-[11px] font-bold text-[#9CA3AF] tracking-widest uppercase">
              <div className="col-span-12 lg:col-span-4">USER</div>
              <div className="hidden lg:block lg:col-span-2">TITLE</div>
                ...
                <div key={req.id} className="grid grid-cols-12 py-8 items-center group relative">
                  <div className="col-span-12 lg:col-span-4 flex items-center gap-6">
                    <div className="w-16 h-16 rounded-2xl overflow-hidden bg-gray-200 border-2 border-white shadow-sm shrink-0">
                      {/* Avatar placeholder */}
                      <div className="w-full h-full bg-[#1A365D] flex items-center justify-center text-white text-xl font-medium">
                        {req.user.charAt(0)}
                      </div>
                    </div>
                    <div className="space-y-2">
                      <p className="text-base font-medium text-[#2C2E33] leading-none">{req.user}</p>
      ...
      <div className="flex items-center justify-center gap-2 mt-12 pb-2">
        <button className="p-2 text-gray-400 hover:text-gray-900 cursor-pointer transition-colors">
