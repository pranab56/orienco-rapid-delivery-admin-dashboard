  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-10">
      ...
      <div className="space-y-1">
        ...
        <p className="text-[#737780] font-normal">Respond to User Messages</p>
      </div>
        ...
        <CardContent className="p-10 pb-4">
          <div className="w-full h-full">
            ...
            <div className="grid grid-cols-12 pb-6 border-b border-gray-200/50 text-[11px] font-bold text-[#9CA3AF] tracking-widest uppercase">
              ...
              <div className="hidden lg:block lg:col-span-3">MESSAGE</div>
              <div className="hidden lg:block lg:col-span-4">CONTACT</div>
              ...
              {mockMessages.map((msg) => (
                <div key={msg.id} className="grid grid-cols-12 py-10 items-center group relative">
                  <div className="col-span-12 lg:col-span-4">
                    <p className="text-base font-bold text-[#2C2E33] leading-none">{msg.user}</p>
                  </div>

                  <div className="hidden lg:block lg:col-span-3">
                    <p className="text-sm font-bold text-[#2C2E33] opacity-80">{msg.message}</p>
                  </div>
