...
function ResetPasswordContent() {
  ...
  const [resendPassword, { isLoading }] = useResendPasswordMutation();
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await resendPassword({ token, data: { newPassword: password, confirmPassword } }).unwrap();
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <div className="relative">
                <Input
                  ...
                  className={cn(
                    ...
                    errors.password ? "focus-visible:ring-red-500 bg-red-50/50" : "focus-visible:ring-[#FF4A00] focus-visible:border-[#FF4A00]"
                  )}
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={cn(
                    "h-12 bg-[#F9FAFB] border-gray-100 rounded-xl focus-visible:ring-1 transition-all pr-10",
                    errors.confirmPassword ? "focus-visible:ring-red-500 bg-red-50/50" : "focus-visible:ring-[#FF4A00] focus-visible:border-[#FF4A00]"
                  )}
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-[#FF4A00] hover:bg-[#FF4A00] hover:opacity-80 text-white rounded-xl text-base font-semibold transition-all shadow-lg shadow-orange-200 group mt-2"
            >
              {isLoading ? 'Resetting...' : (
          ...
          <div className="mt-8 text-center">
            <Link
              href="/auth/login"
              className="text-[#FF4A00] font-semibold hover:underline inline-flex items-center gap-2 group transition-colors"
            >
